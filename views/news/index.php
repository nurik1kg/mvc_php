            ...
            <div class="col-md-9">
                ...
                <div class="well">
                    ...
                    <div class="text-right">
                        <a class="btn btn-success">Add News</a>
                    </div>
                    <?php foreach ($newsList as $newsItem): ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <span class="glyphicon glyphicon-star"></span>
                                <span class="glyphicon glyphicon-star-empty"></span>
                                <b><a href="<?php echo '/news/'.$newsItem['id']; ?>"><?php echo $newsItem['title'];?></a></b>
                                <span class="pull-right"><?php echo $newsItem['date'];?></span>
                                <p><?php echo $newsItem['sh_content'];?></p>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
